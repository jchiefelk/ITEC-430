...
<p><h3><a href="https://github.com/jchiefelk/ITEC-430/tree/master/restAPI">REST API's</a></h3> Clone and deploy a web application built with Python and Flask on your localhost.  Learn how to query servers for data using curl</p>
